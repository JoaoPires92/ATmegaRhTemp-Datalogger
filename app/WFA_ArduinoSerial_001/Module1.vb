...
Module Module1
    ...
    Public Sub LoadArduinoEvents()
        ...
        Try
            ...
            For Aux = 1 To DataArray.Length - 2 Step 7
    ...
    Public Sub DisplayArduinoEvents()
        ...
        StrArduinoList &= "                      " & "  Data" & "            " & "Hora" & "     " & "Temperatura" & "     " & "Humidade" & vbNewLine & vbNewLine

        For Aux1 = 0 To TotalArduinoLoaded - 1

            StrArduinoList &= vbTab & vbTab & A_Arduino(Aux1).Day & "/" &
                 A_Arduino(Aux1).Month & "/" &
                 A_Arduino(Aux1).Year & "       " &
                 A_Arduino(Aux1).Hour & ":" &
                 A_Arduino(Aux1).Minute & "         " &
                 A_Arduino(Aux1).Temperature & " ºC" & "          " &
            A_Arduino(Aux1).Humidity & " %rh" & vbNewLine
    ...
    Public Sub SaveDataIntoTextFile(ByVal FileName As String)
        ...
        AuxStr = "   Data" & "       " & "Hora" & "   " & "Temperatura" & "  " & "Humidade" & vbNewLine & vbNewLine
    ...
    Public Function SaveDataIntoExcelSheet(ByVal FileName As String) As Boolean
        ...
        Try
            ...
            objSheet.Cells(2, 6) = DeviceSN
            objSheet.Cells(4, 6) = Now.Date & " " & Now.Hour & ":" & Now.Minute
            objSheet.Cells(5, 6) = TotalArduinoLoaded & " registos importados para a(s) Data(s) " & EventsDate
            objSheet.Cells(6, 6) = EventsDate
            ...
            For Aux1 = 0 To TotalArduinoLoaded - 1
                ...
                objSheet.Cells(Counter, 4) = A_Arduino(Aux1).Humidity
