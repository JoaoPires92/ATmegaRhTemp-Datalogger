...
Public Class Form1
    ...
    Private Sub GetArduinoDeviceInfo()
        ...
        ElseIf AuxStr.StartsWith("@WSCNR@") Then
            ...
            Else
                MsgBox("O Comando nao foi recebido pelo controlador remoto para se conectar. Tente Novamente", MsgBoxStyle.Critical, "GetArduinoDeviceInfo()")
                RSComandAttempts = 1
                Exit Sub
            End If
        ElseIf AuxStr.StartsWith("@WSSN|") And AuxStr.EndsWith("|@") Then
            ...
            RSComandAttempts = 1
        Else
            MsgBox("Falha ao conectar com o aparelho remoto. Tente Novamente", MsgBoxStyle.Critical, "GetArduinoDeviceInfo()")
            RSComandAttempts = 1
            Exit Sub
        End If
